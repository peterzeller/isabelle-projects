...
object Isabelle_System
{
    ...
    preference: String, envar: String, property: String, description: String): String =
  {
    val value =
      ...
      error("Unknown " + description + s" directory ($preference, ${envar}, $property")
  ...
  {
    println(s"isabelle_system:process command_line = $command_line")
    println(s"isabelle_system:process cwd = $cwd")
//    println(s"isabelle_system:process env = $env")
    println(s"isabelle_system:process redirect = $redirect")
