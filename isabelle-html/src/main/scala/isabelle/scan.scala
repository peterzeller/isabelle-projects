...
import scala.util.parsing.input.{CharSequenceReader, OffsetPosition, PagedSeq, Reader, Position => InputPosition}
import scala.util.parsing.combinator.RegexParsers
import java.io.{BufferedInputStream, FileInputStream, InputStream, File => JFile}
import java.net.URL
